...
import (
	...
	zvolISCSIProvisioner "github.com/yuanying/zvol-iscsi-pv-provisioner/pkg/provisioner"
)

var (
	provisioner = flag.String("provisioner", "unstable.cloud/zvol-iscsi", "Name of the provisioner. The provisioner will only provision volumes for claims that request a StorageClass with a provisioner field set equal to this name.")
...
func main() {
	...
	zip := zvolISCSIProvisioner.NewZvolISCSIProvisioner(config, clientset)
